class Spree::Content < ActiveRecord::Base
  ...
  attr_accessible :page_id, :title, :path, :body, :hide_title, :link, :link_text, :context, :attachment, :delete_attachment, :custom_field_1,:custom_field_2,:custom_field_3,:custom_field_4,:custom_field_5
